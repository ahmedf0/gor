...
type = 'inline',
data = {
{{text = ' 🇮🇶 ┇ 𝖲𝗈𝗎𝗋𝖼𝖾 Lacuste',url="t.me/oooaaa"}},
}
}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/oooaaa&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
...
local UserId_Info = bot.searchPublicChat("Lacuste_labban")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ Lacuste\n\n*[ 🇮🇶 ┇  Lacuste ᴄʜᴀɴɴᴇʟ](http://t.me/oooaaa)*\n\n*[ 🇮🇶 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/oooaaa)*\n\n*[ 🇮🇶 ┇  Lacuste ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/Lacuste_labban)*\n\n*[ 🇮🇶 ┇  ʙᴏᴛ Lacuste](http://t.me/oooaaa)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 Lacuste ',url="t.me/oooaaa"}
